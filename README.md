...
## Models that I run in the cloud
## Euria
https://euria.infomaniak.com/

My day-to-day chatbot. I also Mistral that is integrated into the Firefox sidebar, Claude for specific code/infra related topics and ChatGPT every now and then.

### mistral/codestral
Used through Mistral API inside Continue. I also use Github Copilot in VS Code.
